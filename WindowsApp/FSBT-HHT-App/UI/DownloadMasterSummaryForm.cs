...
{
    public partial class DownloadMasterSummaryForm : Form
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name);
        public DownloadMasterSummaryForm()
        {
            InitializeComponent();
        }
        ...
        public void SummaryDownloadMaster(DataTable listSummaryData, int flg)
        {
            try
            {
                ...
                this.dataGridView1.Columns["Department"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
