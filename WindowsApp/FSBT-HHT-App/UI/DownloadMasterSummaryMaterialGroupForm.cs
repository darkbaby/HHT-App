...
{
    public partial class DownloadMasterSummaryMaterialGroupForm : Form
    {
        private LogErrorBll logBll = new LogErrorBll();
        public DownloadMasterSummaryMaterialGroupForm()
        {
            InitializeComponent();
        }
        ...
        public void SummaryDownloadMaster(DataTable listSummaryData, int flg)
        {
            try
            {
                ...
                this.dataGridView1.Columns["Material Group Code"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
                this.dataGridView1.Columns["Material Group Name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
                //this.dataGridView1.Columns["MatGroup"].Width = 100;
                //this.dataGridView1.Columns["MatGroupName"].Width = 100;
                ...
                //decimal totalQuantity = listSummaryData.AsEnumerable().Sum(x => x.Field<decimal>("Book Quantity"));
