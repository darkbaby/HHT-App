...
namespace FSBT.HHT.App.ReportTemplate {
    ...
    public class RPT_ControlSheet : ReportClass {
        
        public RPT_ControlSheet() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_ControlSheet.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "FSBT.HHT.App.ReportTemplate.RPT_ControlSheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_ControlSheet : Component, ICachedReport {
        
        public CachedRPT_ControlSheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_ControlSheet rpt = new RPT_ControlSheet();
            rpt.Site = this.Site;
            return rpt;
        }
